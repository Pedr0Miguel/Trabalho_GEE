...
function AdminIndex() {
  ...
  return (
    <div className="cards-container">
      ...
      <div
        className="card"
        onClick={() => navigate("/admin/saude-agendamentos")}
      >
      ...
      <div
        className="card"
        onClick={() => navigate("/admin/saude-profissionais")}
      >
        <h2>Profissionais de Saúde</h2>
        <p>Gerencie os profissionais da saúde.</p>
      </div>

      <div className="card" onClick={() => navigate("/admin/usuario")}>
